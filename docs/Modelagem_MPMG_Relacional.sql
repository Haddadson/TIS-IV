...
CREATE TABLE IF NOT EXISTS `mydb`.`NotaFiscal` (
  ...
  INDEX `fk_NotaFiscal_TabelaANP1_idx` (`id_municipio` ASC, `mes` ASC, `ano` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_NotaFiscal_TabelaANP1`
    FOREIGN KEY (`id_municipio` , `mes` , `ano`)
    REFERENCES `mydb`.`TabelaANP` (`id_municipio` , `mes` , `ano`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`TabelaUsuario` (
  ...
  PRIMARY KEY (`sgdp`),
  INDEX `fk_TabelaUsuario_TabelaANP1_idx` (`id_municipio` ASC, `mes` ASC, `ano` ASC) VISIBLE,
  CONSTRAINT `fk_TabelaUsuario_TabelaANP1`
    FOREIGN KEY (`id_municipio` , `mes` , `ano`)
    REFERENCES `mydb`.`TabelaANP` (`id_municipio` , `mes` , `ano`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
