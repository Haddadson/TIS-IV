...
function autocomplete(inp, arr) {
    ...
    inp.addEventListener("input", function (e) {
        ...
        for (i = 0; i < window[arr].length; i++) {
            ...
            if (window[arr][i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
                /*create a DIV element for each matching element:*/
                b = document.createElement("DIV");
                /*make the matching letters bold:*/
                b.innerHTML = "<strong>" + window[arr][i].substr(0, val.length) + "</strong>";
                b.innerHTML += window[arr][i].substr(val.length);
                /*insert a input field that will hold the current window[arr]ay item's value:*/
                b.innerHTML += "<input type='hidden' value='" + window[arr][i] + "'>";
    ...
    inp.addEventListener("keydown", function (e) {
        ...
        if (e.keyCode == 40) {
            /*If the window[arr]ow DOWN key is pressed,
